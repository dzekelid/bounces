...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/bounces/master/_listings/dezrez/apis.md
specificationVersion: "0.14"
apis:
- name: Dezrez.Rezi.Client.Api - creates an event when a envelope is bounced by signable
  x-api-slug: apidigitalsignaturesignablebouncedfingerprint-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/bounces/master/_listings/dezrez/apidigitalsignaturesignablebouncedfingerprint-post-openapi.md
- name: Dezrez.Rezi.Client.Api - creates an event when a envelope is bounced by sendgrid
  x-api-slug: apisendgridbounce-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/bounces/master/_listings/dezrez/apisendgridbounce-post-openapi.md
- name: Dezrez.Rezi.Client.Api - creates an event when a envelope is bounced by signable
  x-api-slug: apidigitalsignaturesignablebouncedfingerprint-post
  description: Creates an event when a envelope is bounced by signable.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28888-www-dezrez-com.jpg
